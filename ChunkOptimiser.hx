...
abstract class ChunkOptimizer<T> {
	...
	public function new(data1:Array<T>, data2:Array<T>, iterable:FairDiffIterable, indicator:CancellationChecker) {
		myData1 = data1;
		myData2 = data2;
		myIterable = iterable;
...
class LineChunkOptimizer extends ChunkOptimizer<Line> {
	public function new(lines1:Array<Line>, lines2:Array<Line>, changes:FairDiffIterable, indicator:CancellationChecker) {
